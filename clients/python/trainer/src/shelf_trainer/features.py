...
``your_query_log_table`` with Iceberg manifest metadata) is a stub.
"""
...
def extract_features(
    ...
    *,
    ...
    ----------
    query_log:
        Raw rows from ``your_query_log_table`` (or a sample thereof).
    as_of:
    ...
    raise NotImplementedError(
        "SHELF-34: feature extraction from your_query_log_table (BLUEPRINT §7.3)."
    )
