...
This document was written during the rep2 active-cutover window on 2026-04-27 with `[shelf-overview](https://platform-grafana.penpencil.co/d/shelf-overview)` open and `cdp.trino_logs.trino_queries` queried in real time. Snapshot reproducible per the steps in `[snapshot.md §9](./perf-research-2026-04-27/snapshot.md#9-reproduction)`.
