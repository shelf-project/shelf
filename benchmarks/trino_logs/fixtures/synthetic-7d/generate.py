...
def _build_silver_events() -> list[dict]:
    """Table 1: ``your_catalog.your_schema.your_events_table`` — 3 partitions.
...
def _build_daily_revenue() -> list[dict]:
    """Table 2: ``your_catalog.your_schema.your_daily_revenue`` — unpartitioned.
...
def _build_page_events() -> list[dict]:
    """Table 3: ``warehouse.your_bronze_schema.your_page_events`` — partitioned by event_date."""
    ...
    trace = [
        {
            ...
            "query": (
                "SELECT user_id FROM your_catalog.your_schema.your_events_table "
        ...
        },
        {
            ...
            "query": "SELECT * FROM your_catalog.your_schema.your_daily_revenue WHERE revenue > 1000",
            "catalog": "warehouse",
            "schema": "your_gold_schema",
            "tables": [
                {
                    "catalog": "warehouse",
                    "schema": "your_gold_schema",
                    "table": "your_daily_revenue",
                    "snapshot_id": 2001,
                }
            ],
        ...
        },
        {
            ...
            "query": (
                "SELECT * FROM warehouse.your_bronze_schema.your_page_events "
        ...
        },
        {
            ...
            "query": "SELECT * FROM your_catalog.your_schema.your_events_table",
            "catalog": "warehouse",
            "schema": "your_schema",
            "tables": [
                {
        ...
        },
        {
            ...
            "query": "SELECT * FROM your_catalog.your_schema.your_daily_revenue WHERE revenue < 100",
            "catalog": "warehouse",
            "schema": "your_gold_schema",
            "tables": [
                {
        ...
        # time because the trace only binds silver_events_2026.
        {
            ...
            "query": (
                "SELECT s.user_id FROM your_catalog.your_schema.your_events_table s "
                "JOIN your_catalog.your_schema.your_daily_revenue r ON s.user_id = r.revenue "
...
def main() -> None:
    ...
    _write_expected(
        {
            "your_catalog.your_schema.your_events_table": silver,
            "your_catalog.your_schema.your_daily_revenue": revenue,
            "warehouse.your_bronze_schema.your_page_events": page_events,
        }
    )
