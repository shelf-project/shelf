...
[
  {
    ...
    "key": "warehouse/cdp_revenue/gold_users/metadata/00001-abcd.metadata.json",
    "size_estimate": null,
    "access_count": 2293,
    "table": "cdp.cdp_revenue.gold_users"
  },
  ...
]
```
...
`cdp.cdp_revenue.gold_users`, `cdp.admin.iceberg_maintenance_log`).
