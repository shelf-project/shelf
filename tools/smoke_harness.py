...
@dataclass
class TableDefaults:
    large_fact: str = "your_schema.your_users_table"
    small_dim: str = "admin.iceberg_maintenance_log"
    small_dim_pk: str = "log_time"
    agg_fact: str = "your_schema.your_users_table"
    agg_col: str = "country"
    join_fact: str = "your_schema.gold_orders"
    join_dim: str = "your_schema.your_users_table"
    join_key: str = "user_id"
    snap_table: str = "your_schema.your_users_table"
