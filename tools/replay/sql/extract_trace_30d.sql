-- SHELF-35 — extract a 30-day trace from cdp.trino_logs.trino_queries.
--
...
--
--   * cdp.trino_logs.trino_queries records inputs_json with one entry
...
-- window.
--
-- Safety: SELECT only. No catalog mutation. ``cdp.trino_logs.trino_queries``
...
WITH expanded AS (
  ...
  FROM cdp.trino_logs.trino_queries q
